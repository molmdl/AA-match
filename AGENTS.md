...
- **VMD:** Assume only what VMD 1.9.3 ships (Tcl/Tk 8.5 + ttk). Zero external deps confirmed. Any additional tcl lib (e.g. tooltip.tcl) must be user-approved and vendored under `vmd/3rd_party_lib/` with license noted. See `vmd/AGENTS.md`.
